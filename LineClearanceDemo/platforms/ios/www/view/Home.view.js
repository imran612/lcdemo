sap.ui.jsview("com.jbl.lnclr.tab.view.Home", {
	...
	createContent: function (oController) {
              ...
              page.setCustomHeader(new sap.m.Bar("pageHdr1",{contentLeft: new sap.m.Image({src:"img/nypro-ls-logo.png"}).addStyleClass("nyLogo"),contentRight:[new sap.m.Text({text:"Welcome Guest"}).addStyleClass("welHdr"),new sap.m.Button({icon:"sap-icon://log"}) ]}));
              ...
              /*var lcStatusBar = new sap.m.Bar({contentLeft: new sap.m.Text("lctypefld",{text:"Select Line Clearance Type"}).addStyleClass("lcTypeLabel"),contentRight:new sap.m.Button({icon:"sap-icon://navigation-down-arrow",press:oController.handleLCType}).addStyleClass("selArrow") }).addStyleClass("lcTypeBar");*/
                 /* lcStatusBar.attachBrowserEvent("click",function(oevent) {
                                         handleLCTypeSel();
                                         });*/
              ...
              /*scanBar.attachBrowserEvent("click",function(oevent) {
                                         scan();
                                         });*/
